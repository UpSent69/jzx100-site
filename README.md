...
Пространств два, и устроены они по-разному намеренно. Первое, «Почему JZX100 —
король японского дрифта», открывается кнопкой «Подробнее» из первой паузы
и едет вбок одной непрерывной лентой. Второе, «Keep it street», открывается
из второй паузы и идёт сверху вниз разворотами: экран делится пополам — кадр
во весь рост на одной половине, ровный фон с крупной репликой на другой, —
а между разворотами лежат мозаики из кадров и полосы во весь экран.
