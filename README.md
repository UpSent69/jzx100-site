...
src/js/space.js       отдельное пространство поверх страницы
...
экраны 1–5 целиком, паузы между слайдами, иллюстрация с переходом в отдельное
пространство, прелоадер, переключатель звука, мобильная раскладка.
...
Шестой экран стоит на заглушке. Оформление пространства, которое открывается
кнопкой «Подробнее», — следующая задача: сейчас там заголовок, подпись и фон.
